...
public class CustomMissionView extends MissionManagerBaseView {
    ...
    private DJIWaypointMission initTestingWaypointMission() {
        ...
        double d = 10 * Utils.ONE_METER_OFFSET;
        DJIWaypoint northPoint = new DJIWaypoint(mHomeLatitude + d, mHomeLongitude, 10f);
        DJIWaypoint eastPoint = new DJIWaypoint(mHomeLatitude, mHomeLongitude , 20f);
